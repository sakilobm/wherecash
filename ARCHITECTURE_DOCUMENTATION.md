...
- **Atomic Presentation Components**:
  ...
  - [AccountFormSheet.tsx](file:///c:/Users/sowbh/Desktop/MoneyApp/src/components/accounts/AccountFormSheet.tsx): Progressive 2-step creation wizard. Step 1 guides the user through choosing account purpose (Checking, Cash, Savings, Credit, Investment). Step 2 focuses on live preview, name, and balance, with advanced color/icon customization and primary toggles neatly tucked into an expandable drawer to eliminate decision fatigue.
